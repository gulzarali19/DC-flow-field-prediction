...
![Alt Text](results/Methodology.png)
...
Thermal Field Comparison (CFD vs. CNN)
The following image shows the ground truth generated by ANSYS Fluent compared to the prediction generated by our Deep Learning model. The surrogate model accurately captures the thermal plumes and airflow patterns.
